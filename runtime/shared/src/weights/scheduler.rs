...
impl<T: polkadot_sdk::frame_system::Config> polkadot_sdk::pallet_scheduler::WeightInfo for AllfeatWeight<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(6_640_000, 1489)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_383_735, 13328)
			// Standard Error: 2_361
			.saturating_add(Weight::from_parts(427_009, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	fn service_task_base() -> Weight {
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(44_200_000, 3678)
			// Standard Error: 1
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(20_890_140, 13328)
			// Standard Error: 2_868
			.saturating_add(Weight::from_parts(458_368, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_995_810, 13328)
			// Standard Error: 4_014
			.saturating_add(Weight::from_parts(688_561, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(26_241_110, 13328)
			// Standard Error: 4_601
			.saturating_add(Weight::from_parts(518_437, 0).saturating_mul(s.into()))
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(27_620_699, 13328)
			// Standard Error: 4_277
			.saturating_add(Weight::from_parts(686_212, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn schedule_retry(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_802_874, 13328)
			// Standard Error: 989
	...
	fn set_retry() -> Weight {
		...
		Weight::from_parts(34_680_000, 13328)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_retry_named() -> Weight {
		...
		Weight::from_parts(42_680_000, 13328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:0)
	...
	fn cancel_retry() -> Weight {
		...
		Weight::from_parts(33_320_000, 13328)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:0)
	...
	fn cancel_retry_named() -> Weight {
		...
		Weight::from_parts(41_200_000, 13328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
