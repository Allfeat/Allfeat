...
// --heap-pages=4096
// --output=./runtime/shared/src/weights/bags-list.rs
// --header=./HEADER
...
impl<T: frame_system::Config> pallet_bags_list::WeightInfo for AllfeatWeight<T> {
	...
	fn rebag_non_terminal() -> Weight {
		...
		Weight::from_parts(89_640_000, 11314)
	...
	fn rebag_terminal() -> Weight {
		...
		//  Measured:  `1272`
		//  Estimated: `8733`
		// Minimum execution time: 83_201_000 picoseconds.
		Weight::from_parts(85_720_000, 8733)
			.saturating_add(T::DbWeight::get().reads(7_u64))
			.saturating_add(T::DbWeight::get().writes(5_u64))
	}
	/// Storage: `BagsList::ListNodes` (r:4 w:4)
	...
	fn put_in_front_of() -> Weight {
		...
		//  Measured:  `1485`
		//  Estimated: `11314`
		// Minimum execution time: 98_920_000 picoseconds.
		Weight::from_parts(101_281_000, 11314)
