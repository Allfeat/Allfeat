...
impl<T: frame_system::Config> frame_system::WeightInfo for AllfeatWeight<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_parts(12_320_482, 0)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(515, 0).saturating_mul(b.into()))
	}
	/// The range of component `b` is `[0, 3932160]`.
	fn remark_with_event(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_parts(7_275_000, 1485)
	...
	fn set_code() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `1485`
		// Minimum execution time: 138_265_054_000 picoseconds.
		Weight::from_parts(143_927_323_000, 1485)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(4_594_000, 0)
			...
			.saturating_add(Weight::from_parts(1_161_647, 0).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(4_057_000, 0)
			...
			.saturating_add(Weight::from_parts(844_955, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: `Skipped::Metadata` (r:0 w:0)
	/// Proof: `Skipped::Metadata` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_parts(7_487_000, 98)
			// Standard Error: 3_209
			.saturating_add(Weight::from_parts(1_517_281, 0).saturating_mul(p.into()))
