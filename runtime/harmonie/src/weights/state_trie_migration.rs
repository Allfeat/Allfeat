...
// --heap-pages=4096
// --output=./runtime/harmonie/src/weights/state-trie-migration.rs
...
impl<T: frame_system::Config> pallet_state_trie_migration::WeightInfo for AllfeatWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(21_863_000, 2527)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(7_184_000, 1493)
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		Weight::from_parts(42_694_000, 3511)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	fn migrate_custom_child_success() -> Weight {
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		Weight::from_parts(42_404_000, 3571)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		Weight::from_parts(8_915_000, 3523)
			// Standard Error: 8
			.saturating_add(Weight::from_parts(2_372, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
