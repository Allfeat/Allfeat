...
impl<T: frame_system::Config> frame_system::WeightInfo for AllfeatWeight<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_parts(23_714_948, 0)
			// Standard Error: 14
	...
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_parts(34_539_000, 0)
			// Standard Error: 9
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_parts(23_989_000, 1485)
	...
	fn set_code() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `1485`
		// Minimum execution time: 277_931_744_000 picoseconds.
		Weight::from_parts(373_472_548_000, 1485)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(12_062_000, 0)
			// Standard Error: 31_351
			.saturating_add(Weight::from_parts(3_756_700, 0).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(50_990_213, 0)
			// Standard Error: 43_515
			.saturating_add(Weight::from_parts(2_421_922, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: `Skipped::Metadata` (r:0 w:0)
	/// Proof: `Skipped::Metadata` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_parts(15_522_164, 92)
			// Standard Error: 52_232
			.saturating_add(Weight::from_parts(4_096_621, 0).saturating_mul(p.into()))
