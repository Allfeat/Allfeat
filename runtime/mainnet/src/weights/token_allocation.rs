...
impl<T: frame_system::Config> WeightInfo for AllfeatWeight<T> {
	...
	fn add_allocation() -> Weight {
		...
		//  Measured:  `1137`
		//  Estimated: `6196`
		// Minimum execution time: 124_867_000 picoseconds.
		Weight::from_parts(125_847_000, 6196)
	...
	fn on_initialize_noop() -> Weight {
		...
		Weight::from_parts(4_769_000, 1489)
	...
	fn on_initialize_partial() -> Weight {
		...
		//  Measured:  `86906`
		//  Estimated: `668162`
		// Minimum execution time: 15_414_414_000 picoseconds.
		Weight::from_parts(15_671_180_000, 668162)
	...
	fn on_initialize_epoch_finished(x: u32, ) -> Weight {
		...
		// Minimum execution time: 141_307_000 picoseconds.
		Weight::from_parts(142_157_000, 3989)
			// Standard Error: 49_275
			.saturating_add(Weight::from_parts(60_799_927, 0).saturating_mul(x.into()))
