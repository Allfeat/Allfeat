...
// --output=/Users/snow/Development/Allfeat/Allfeat/runtime/mainnet/src/weights/grandpa.rs
...
impl<T: frame_system::Config> WeightInfo for AllfeatWeight<T> {
	...
	fn report_equivocation(
		...
		Weight::from_parts(64_928_571, 0)
			// Standard Error: 171_115
			.saturating_add(
				Weight::from_parts(2_671_428, 0).saturating_mul(validator_count.min(1).into()),
			)
	}
