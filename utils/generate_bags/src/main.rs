...
use harmonie_runtime::Runtime as HarmonieRuntime;
...
impl Runtime {
	fn generate_thresholds_fn(
		...
		match self {
			Runtime::Harmonie => Box::new(generate_thresholds::<HarmonieRuntime>),
		}
	}
}
...
struct Opt {
	...
	#[arg(long, ignore_case = true, value_enum, default_value_t = Runtime::Harmonie)]
	runtime: Runtime,
