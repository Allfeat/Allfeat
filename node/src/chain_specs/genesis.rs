...
use symphonie_runtime::{
	...
	BabeConfig, BalancesConfig, GrandpaConfig, ImOnlineConfig, IndicesConfig, MaxNominations,
	MusicStylesConfig, SessionConfig, StakerStatus, StakingConfig, SudoConfig, SystemConfig,
};
